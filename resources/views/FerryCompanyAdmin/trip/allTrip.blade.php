...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
        	...
        	<form  class="form-horizontal" role="form" action="{{route('viewAllCompanyTrip')}}" method="GET">
        	
        		<!-- <input type="text" placeholder="Search Trip " name="ferry_name" class="form-control" /> -->
        		<div class="col-md-2">   
				...
				<tbody>
					@foreach($trips as $trip)
							<tr>
                                ...
                                @else
    								<td>
    									<a class="btn btn-raised btn-success editUser"  href="{{route('editCompanyTrip', ['tripId' => $trip->id ])}}"> Edit 
    									</a>
    								</td>
                                @endif    
							</tr>
