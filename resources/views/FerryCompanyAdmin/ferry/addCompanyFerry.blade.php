    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><center><h3> Add Ferry </h3> </center></div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('insertCompanyFerry') }}"  enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('captainName') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="captainName" type="text" class="form-control" name="captainName" value="{{ old('captainName') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('numberOfSeat') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="numberOfSeat" type="number" class="form-control" name="numberOfSeat" value="{{ old('numberOfSeat') }}" required autofocus min="0">
                        ...
                        <div class="form-group{{ $errors->has('numberOfCrew') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="numberOfCrew" type="number" class="form-control" name="numberOfCrew" value="{{ old('numberOfCrew') }}" required autofocus min="0">
                        ...
                        <div class="form-group{{ $errors->has('status') ? ' has-error' : ''}}">
                            <label for="status" class="col-md-4 control-label">Activate
                            </label>
                            <div class="col-md-4">   
                                <div class="btn-group" id="status" data-toggle="buttons">
                                  <label class="btn btn-default btn-on active">
                                  <input type="radio" value="1" name="status" checked="checked">Activate</label>
                                  <label class="btn btn-default btn-off">
                                  <input type="radio" value="0" name="status">Inactivate</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('logo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6" >
                                <img id="logoPreview" src="#" alt="Image " height="90px" width="90px"/>
