    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading">Edit Port</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('edit_port_post', ['port' => $port->id]) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ old('name') ? old('name') : $port->name }}">
                        ...
                        <div class="form-group{{ $errors->has('city_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="city_name" type="text" class="form-control" name="city_name" value="{{ old('city_name') ? old('city_name') : $port->city_name }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="country_code">
                                    ...
                                    @foreach($countries as $code => $country)
                                        <option value="{{$code}}" {{ $port->country_code == $code ? 'selected' : '' }}>
                                            {{ $country }} 
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group{{ ($errors->has('latitude') || $errors->has('longitude')) ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="latitude" type="text" class="form-control" name="latitude" value="{{ old('latitude') ? old('latitude') : $port->latitude }}">
                            ...
                            <div class="col-md-3">
                                <input id="longitude" type="text" class="form-control" name="longitude" value="{{ old('longitude') ? old('longitude') : $port->longitude }}">
